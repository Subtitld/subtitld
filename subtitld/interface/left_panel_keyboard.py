from PySide6.QtWidgets import QVBoxLayout, QWidget, QLabel, QScrollArea, QHBoxLayout, QPushButton, QTableWidget, QTableWidgetItem, QHeaderView, QAbstractItemView, QLineEdit, QSizePolicy, QGridLayout
...
def load(self):
    ...
    left_panel_keyboard_panel = QWidget()
    left_panel_keyboard_panel.setObjectName(f'left_panel_{tab_name}')
    left_panel_keyboard_panel.setProperty('tab_name', tab_name)
    left_panel_keyboard_panel.setLayout(QVBoxLayout())
    left_panel_keyboard_panel.layout().setContentsMargins(10, 10, 10, 10)

    left_panel_keyboard_panel_scroll = QScrollArea()
    left_panel_keyboard_panel_scroll.setObjectName('left_panel_keyboard_panel_scroll')
    left_panel_keyboard_panel_scroll.setWidgetResizable(True)
    left_panel_keyboard_panel_scroll.setFrameShape(QScrollArea.NoFrame)
    left_panel_keyboard_panel.layout().addWidget(left_panel_keyboard_panel_scroll)

    self.left_panel_keyboard_panel_widget = QWidget()
    self.left_panel_keyboard_panel_widget.setObjectName('left_panel_keyboard_panel_widget')
    self.left_panel_keyboard_panel_widget.setLayout(QVBoxLayout())
    self.left_panel_keyboard_panel_widget.layout().setContentsMargins(0, 0, 0, 0)
    left_panel_keyboard_panel_scroll.setWidget(self.left_panel_keyboard_panel_widget)
    ...
    self.left_panel_keyboard_panel_widget.layout().addWidget(self.global_panel_tabwidget_shortkeys_table)
    ...
    self.left_panel_keyboard_panel_widget.layout().addLayout(self.global_panel_tabwidget_shortkeys_details)

    left_panel_keyboard_panel.update = update

    left_panel.add_panel(self, left_panel_keyboard_panel)
...
def translate(self):    
    self.global_panel_keyboardshortcut_change_button.setText(_('keyboard_panel.change'))
    self.global_panel_keyboardshortcut_confirm_button.setText(_('keyboard_panel.confirm'))
    self.global_panel_keyboardshortcut_cancel_button.setText(_('keyboard_panel.cancel'))
    self.global_panel_keyboardshortcut_clear_button.setText(_('keyboard_panel.clear'))
    self.global_panel_tabwidget_shortkeys_details_warning.setText(_('keyboard_panel.select_a_command'))
